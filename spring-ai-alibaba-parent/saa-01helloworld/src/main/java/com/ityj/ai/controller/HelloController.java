...
public class HelloController {
    ...
    @GetMapping("/chat")
    public String chat(@RequestParam(value = "content", defaultValue = "你是谁？") String content) {
        log.info("chatModel is :{}", chatModel);
        log.info("input content is :{}, model is :{}, dashScopeConnectionProperties.baseUrl is :{}",
